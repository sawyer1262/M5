...
#ifdef NO_FACE_MODE   
const char ver[40]="M5W_H3.0_S1.0_230224_release";                       //硬件版本3.0代表新版本4202E芯片
#else
const char ver[40]="M5FW_H3.0_S1.1_230224_release";                      //硬件版本3.0代表新版本4202E芯片
